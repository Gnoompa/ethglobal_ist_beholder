...
/******/ 			if (chunkId === 3073) return "bundled/chunk.3073.js";
/******/ 			// return url for filenames based on template
/******/ 			return "bundled/" + ({"1077":"npm-ns.dimensiondev.mask-wallet-core","8117":"npm.protobufjs"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
;// CONCATENATED MODULE: ./packages/mask/web-workers/prepare.ts
...
;// CONCATENATED MODULE: ./packages/mask/web-workers/wallet.ts

// How to interact with this worker:
async function load() {
    return Promise.all(/* import() */[__webpack_require__.e(1077), __webpack_require__.e(3073)]).then(__webpack_require__.bind(__webpack_require__, 56147));
}
const promise = (async ()=>{
    const { request } = await load();
    const { api } = await Promise.all(/* import() */[__webpack_require__.e(1077), __webpack_require__.e(8117), __webpack_require__.e(6220)]).then(__webpack_require__.bind(__webpack_require__, 81019));
    return {
        request,
        api
    };
...
/******/ })()
;
//# sourceMappingURL=chunk.MaskWallet.js.map