"use strict";
(globalThis["webpackChunkmask_network"] = globalThis["webpackChunkmask_network"] || []).push([[4275],{
...
__webpack_require__.d(__webpack_exports__, {
  Z: () => (/* reexport */ createVirtualEnvironment)
});

// EXTERNAL MODULE: ./node_modules/.pnpm/@locker+near-membrane-base@0.11.10/node_modules/@locker/near-membrane-base/dist/index.mjs
var dist = __webpack_require__(61306);
;// CONCATENATED MODULE: ./node_modules/.pnpm/@masknet+membrane@0.1.5/node_modules/@masknet/membrane/dist/createMembraneMarshall.js
// @ts-nocheck
// This file is built from '@locker/near-membrane-base'.createMembraneMarshall.
// DO NOT edit it manually.
/* harmony default export */ const createMembraneMarshall = ({
    bindings: [
        {
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@masknet+membrane@0.1.5/node_modules/@masknet/membrane/dist/membrane.js

const connectorMap = /*#__PURE__*/ new WeakMap();
const debuggerMap = /*#__PURE__*/ new WeakMap();
function createConnector(globalThis, isMainIsolate, allowDebug = false) {
    if (connectorMap.has(globalThis))
        return connectorMap.get(globalThis);
    let f;
    createMembraneMarshall.execute({
        set default(value) {
            f = value;
        },
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@masknet+membrane@0.1.5/node_modules/@masknet/membrane/dist/evaluator.js
...
function createVirtualEnvironment(globalObject, redGlobalObject, options) {
    ...
    if (shouldUseDefaultGlobalOwnKeys && defaultGlobalOwnKeys === null) {
        defaultGlobalOwnKeys = (0,dist/* getFilteredGlobalOwnKeys */.CZ)(redGlobalObject);
    }
    env.lazyRemapProperties(globalObject, shouldUseDefaultGlobalOwnKeys ? defaultGlobalOwnKeys : (0,dist/* getFilteredGlobalOwnKeys */.CZ)(globalObjectShape));
    if (endowments) {
        const filteredEndowments = {};
        (0,dist/* assignFilteredGlobalDescriptorsFromPropertyDescriptorMap */.ES)(filteredEndowments, endowments);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@masknet+membrane@0.1.5/node_modules/@masknet/membrane/dist/index.js
...
//# sourceMappingURL=npm-ns.masknet.membrane.js.map