"use strict";
(globalThis["webpackChunkmask_network"] = globalThis["webpackChunkmask_network"] || []).push([[2939],{
...
/* harmony export */   Kg: () => (/* binding */ Pool),
/* harmony export */   cH: () => (/* binding */ SwapRouter),
/* harmony export */   d_: () => (/* binding */ computePoolAddress),
/* harmony export */   ho: () => (/* binding */ Trade),
/* harmony export */   lk: () => (/* binding */ FeeAmount),
/* harmony export */   xK: () => (/* binding */ encodeRouteToPath)
/* harmony export */ });
/* unused harmony exports ADDRESS_ZERO, FACTORY_ADDRESS, FullMath, LiquidityMath, Multicall, NoTickDataProvider, NonfungiblePositionManager, POOL_INIT_CODE_HASH, Payments, Position, PositionLibrary, SelfPermit, SqrtPriceMath, Staker, SwapMath, SwapQuoter, TICK_SPACINGS, Tick, TickLibrary, TickList, TickListDataProvider, TickMath, encodeSqrtRatioX96, isSorted, maxLiquidityForAmounts, mostSignificantBit, nearestUsableTick, priceToClosestTick, subIn256, tickToPrice, toHex, tradeComparator */
/* harmony import */ var _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(51944);
/* harmony import */ var jsbi__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20365);
...
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(24316);
/* harmony import */ var _ethersproject_abi__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(97166);
/* harmony import */ var _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(79335);
/* harmony import */ var _ethersproject_address__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(32329);
/* harmony import */ var _ethersproject_solidity__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(14622);
/* harmony import */ var _uniswap_v3_periphery_artifacts_contracts_interfaces_IMulticall_sol_IMulticall_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(58395);
/* harmony import */ var _uniswap_v3_periphery_artifacts_contracts_NonfungiblePositionManager_sol_NonfungiblePositionManager_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(98057);
/* harmony import */ var _uniswap_v3_periphery_artifacts_contracts_interfaces_ISelfPermit_sol_ISelfPermit_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99363);
/* harmony import */ var _uniswap_v3_periphery_artifacts_contracts_interfaces_IPeripheryPaymentsWithFee_sol_IPeripheryPaymentsWithFee_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2094);
/* harmony import */ var _uniswap_v3_periphery_artifacts_contracts_lens_Quoter_sol_Quoter_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(78398);
/* harmony import */ var _uniswap_swap_router_contracts_artifacts_contracts_lens_QuoterV2_sol_QuoterV2_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(65211);
/* harmony import */ var _uniswap_v3_staker_artifacts_contracts_UniswapV3Staker_sol_UniswapV3Staker_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(39388);
/* harmony import */ var _uniswap_v3_periphery_artifacts_contracts_SwapRouter_sol_SwapRouter_json__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(49637);
...
function computePoolAddress(_ref) {
  ...
  return (0,_ethersproject_address__WEBPACK_IMPORTED_MODULE_10__/* .getCreate2Address */ .hB)(factoryAddress, (0,_ethersproject_solidity__WEBPACK_IMPORTED_MODULE_11__/* .keccak256 */ .wn)(['bytes'], [_ethersproject_abi__WEBPACK_IMPORTED_MODULE_12__/* .defaultAbiCoder */ .$.encode(['address', 'address', 'uint24'], [token0.address, token1.address, fee])]), initCodeHashManualOverride != null ? initCodeHashManualOverride : POOL_INIT_CODE_HASH);
}
...
function multiplyIn256(x, y) {
  ...
  return jsbi__WEBPACK_IMPORTED_MODULE_1___default().bitwiseAnd(product, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .MaxUint256 */ .Bz);
}

function addIn256(x, y) {
  var sum = jsbi__WEBPACK_IMPORTED_MODULE_1___default().add(x, y);
  return jsbi__WEBPACK_IMPORTED_MODULE_1___default().bitwiseAnd(sum, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .MaxUint256 */ .Bz);
}
...
var SqrtPriceMath = /*#__PURE__*/function () {
  ...
  SqrtPriceMath.getNextSqrtPriceFromInput = function getNextSqrtPriceFromInput(sqrtPX96, liquidity, amountIn, zeroForOne) {
    !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(sqrtPX96, ZERO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(liquidity, ZERO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  ...
  SqrtPriceMath.getNextSqrtPriceFromAmount0RoundingUp = function getNextSqrtPriceFromAmount0RoundingUp(sqrtPX96, liquidity, amount, add) {
    ...
    if (add) {
      ...
      !jsbi__WEBPACK_IMPORTED_MODULE_1___default().equal(jsbi__WEBPACK_IMPORTED_MODULE_1___default().divide(_product, amount), sqrtPX96) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
      !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(numerator1, _product) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  ...
  SqrtPriceMath.getNextSqrtPriceFromAmount1RoundingDown = function getNextSqrtPriceFromAmount1RoundingDown(sqrtPX96, liquidity, amount, add) {
    if (add) {
      ...
      !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(sqrtPX96, _quotient) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
...
function mostSignificantBit(x) {
  !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(x, ZERO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  !jsbi__WEBPACK_IMPORTED_MODULE_1___default().lessThanOrEqual(x, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .MaxUint256 */ .Bz) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  var msb = 0;
...
var TickMath = /*#__PURE__*/function () {
  ...
  TickMath.getSqrtRatioAtTick = function getSqrtRatioAtTick(tick) {
    !(tick >= TickMath.MIN_TICK && tick <= TickMath.MAX_TICK && Number.isInteger(tick)) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    ...
    if (tick > 0) ratio = jsbi__WEBPACK_IMPORTED_MODULE_1___default().divide(_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .MaxUint256 */ .Bz, ratio); // back to Q96
  ...
  TickMath.getTickAtSqrtRatio = function getTickAtSqrtRatio(sqrtRatioX96) {
    !(jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThanOrEqual(sqrtRatioX96, TickMath.MIN_SQRT_RATIO) && jsbi__WEBPACK_IMPORTED_MODULE_1___default().lessThan(sqrtRatioX96, TickMath.MAX_SQRT_RATIO)) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
...
var TickList = /*#__PURE__*/function () {
  ...
  TickList.validateList = function validateList(ticks, tickSpacing) {
    !(tickSpacing > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0; // ensure ticks are spaced appropriately

    !ticks.every(function (_ref) {
      var index = _ref.index;
      return index % tickSpacing === 0;
    }) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0; // ensure tick liquidity deltas sum to 0
    ...
    }, ZERO), ZERO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    !isSorted(ticks, tickComparator) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  };

  TickList.isBelowSmallest = function isBelowSmallest(ticks, tick) {
    !(ticks.length > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  ...
  TickList.getTick = function getTick(ticks, index) {
    ...
    !(tick.index === index) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    return tick;
  }
  /**
  ...
  TickList.binarySearch = function binarySearch(ticks, tick) {
    !!this.isBelowSmallest(ticks, tick) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    var l = 0;
  ...
  TickList.nextInitializedTick = function nextInitializedTick(ticks, tick, lte) {
    if (lte) {
      !!TickList.isBelowSmallest(ticks, tick) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
      ...
      !!this.isAtOrAboveLargest(ticks, tick) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
...
function encodeRouteToPath(route, exactOutput) {
  ...
  return exactOutput ? (0,_ethersproject_solidity__WEBPACK_IMPORTED_MODULE_11__/* .pack */ .P2)(types.reverse(), path.reverse()) : (0,_ethersproject_solidity__WEBPACK_IMPORTED_MODULE_11__/* .pack */ .P2)(types, path);
}
...
function encodeSqrtRatioX96(amount1, amount0) {
  ...
  return (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .sqrt */ ._b)(ratioX192);
}
...
function nearestUsableTick(tick, tickSpacing) {
  !(Number.isInteger(tick) && Number.isInteger(tickSpacing)) ?  false ? 0 : invariant(false) : void 0;
  !(tickSpacing > 0) ?  false ? 0 : invariant(false) : void 0;
  !(tick >= TickMath.MIN_TICK && tick <= TickMath.MAX_TICK) ?  false ? 0 : invariant(false) : void 0;
...
var Q128 = /*#__PURE__*/(/* unused pure expression or super */ null && (JSBI.exponentiate( /*#__PURE__*/JSBI.BigInt(2), /*#__PURE__*/JSBI.BigInt(128))));
var PositionLibrary = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  /**
   * Cannot be constructed.
   */
...
function tickToPrice(baseToken, quoteToken, tick) {
  ...
  return baseToken.sortsBefore(quoteToken) ? new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Price */ .tA(baseToken, quoteToken, Q192, ratioX192) : new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Price */ .tA(baseToken, quoteToken, ratioX192, Q192);
}
/**
...
var Q256 = /*#__PURE__*/(/* unused pure expression or super */ null && (JSBI.exponentiate( /*#__PURE__*/JSBI.BigInt(2), /*#__PURE__*/JSBI.BigInt(256))));
...
var TickLibrary = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  /**
   * Cannot be constructed.
   */
...
var Tick = function Tick(_ref) {
  ...
  !(index >= TickMath.MIN_TICK && index <= TickMath.MAX_TICK) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  this.index = index;
...
var Pool = /*#__PURE__*/function () {
  ...
  function Pool(tokenA, tokenB, fee, sqrtRatioX96, liquidity, tickCurrent, ticks) {
    ...
    !(Number.isInteger(fee) && fee < 1000000) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    ...
    !(jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThanOrEqual(jsbi__WEBPACK_IMPORTED_MODULE_1___default().BigInt(sqrtRatioX96), tickCurrentSqrtRatioX96) && jsbi__WEBPACK_IMPORTED_MODULE_1___default().lessThanOrEqual(jsbi__WEBPACK_IMPORTED_MODULE_1___default().BigInt(sqrtRatioX96), nextTickSqrtRatioX96)) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  ...
  _proto.priceOf = function priceOf(token) {
    !this.involvesToken(token) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    ...
    var _getOutputAmount = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(inputAmount, sqrtPriceLimitX96) {
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              !this.involvesToken(inputAmount.currency) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
            ...
            case 4:
              ...
              return _context.abrupt("return", [_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(outputToken, jsbi__WEBPACK_IMPORTED_MODULE_1___default().multiply(outputAmount, NEGATIVE_ONE)), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, liquidity, tickCurrent, this.tickDataProvider)]);
    ...
    var _getInputAmount = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(outputAmount, sqrtPriceLimitX96) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              !(outputAmount.currency.isToken && this.involvesToken(outputAmount.currency)) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
            ...
            case 4:
              ...
              return _context2.abrupt("return", [_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(inputToken, inputAmount), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, liquidity, tickCurrent, this.tickDataProvider)]);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              if (zeroForOne) {
                !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(sqrtPriceLimitX96, TickMath.MIN_SQRT_RATIO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
                !jsbi__WEBPACK_IMPORTED_MODULE_1___default().lessThan(sqrtPriceLimitX96, this.sqrtRatioX96) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
              } else {
                !jsbi__WEBPACK_IMPORTED_MODULE_1___default().lessThan(sqrtPriceLimitX96, TickMath.MAX_SQRT_RATIO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
                !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(sqrtPriceLimitX96, this.sqrtRatioX96) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
              }
  ...
  _createClass(Pool, [{
    ...
    get: function get() {
      ...
      return (_this$_token0Price = this._token0Price) != null ? _this$_token0Price : this._token0Price = new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Price */ .tA(this.token0, this.token1, Q192, jsbi__WEBPACK_IMPORTED_MODULE_1___default().multiply(this.sqrtRatioX96, this.sqrtRatioX96));
    }
    /**
    ...
    get: function get() {
      ...
      return (_this$_token1Price = this._token1Price) != null ? _this$_token1Price : this._token1Price = new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Price */ .tA(this.token1, this.token0, jsbi__WEBPACK_IMPORTED_MODULE_1___default().multiply(this.sqrtRatioX96, this.sqrtRatioX96), Q192);
    }
  }, {
    key: "chainId",
    get: function get() {
...
var Position = /*#__PURE__*/function () {
  ...
  function Position(_ref) {
    ...
    !(tickLower < tickUpper) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    !(tickLower >= TickMath.MIN_TICK && tickLower % pool.tickSpacing === 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    !(tickUpper <= TickMath.MAX_TICK && tickUpper % pool.tickSpacing === 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    this.pool = pool;
  ...
  _proto.ratiosAfterSlippage = function ratiosAfterSlippage(slippageTolerance) {
    var priceLower = this.pool.token0Price.asFraction.multiply(new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Percent */ .gG(1).subtract(slippageTolerance));
  ...
  Position.fromAmount0 = function fromAmount0(_ref3) {
    ...
    return Position.fromAmounts({
      ...
      tickUpper: tickUpper,
      amount0: amount0,
      amount1: _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .MaxUint256 */ .Bz,
  ...
  Position.fromAmount1 = function fromAmount1(_ref4) {
    ...
    return Position.fromAmounts({
      ...
      tickLower: tickLower,
      tickUpper: tickUpper,
      amount0: _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .MaxUint256 */ .Bz,
      amount1: amount1,
  ...
  _createClass(Position, [{
    ...
    get: function get() {
      if (this._token0Amount === null) {
        if (this.pool.tickCurrent < this.tickLower) {
          this._token0Amount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(this.pool.token0, SqrtPriceMath.getAmount0Delta(TickMath.getSqrtRatioAtTick(this.tickLower), TickMath.getSqrtRatioAtTick(this.tickUpper), this.liquidity, false));
        } else if (this.pool.tickCurrent < this.tickUpper) {
          this._token0Amount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(this.pool.token0, SqrtPriceMath.getAmount0Delta(this.pool.sqrtRatioX96, TickMath.getSqrtRatioAtTick(this.tickUpper), this.liquidity, false));
        } else {
          this._token0Amount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(this.pool.token0, ZERO);
        }
      }
    ...
    get: function get() {
      if (this._token1Amount === null) {
        if (this.pool.tickCurrent < this.tickLower) {
          this._token1Amount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(this.pool.token1, ZERO);
        } else if (this.pool.tickCurrent < this.tickUpper) {
          this._token1Amount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(this.pool.token1, SqrtPriceMath.getAmount1Delta(TickMath.getSqrtRatioAtTick(this.tickLower), this.pool.sqrtRatioX96, this.liquidity, false));
        } else {
          this._token1Amount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(this.pool.token1, SqrtPriceMath.getAmount1Delta(TickMath.getSqrtRatioAtTick(this.tickLower), TickMath.getSqrtRatioAtTick(this.tickUpper), this.liquidity, false));
        }
      }
...
var Route = /*#__PURE__*/function () {
  ...
  function Route(pools, input, output) {
    this._midPrice = null;
    !(pools.length > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    var chainId = pools[0].chainId;
    var allOnSameChain = pools.every(function (pool) {
      return pool.chainId === chainId;
    });
    !allOnSameChain ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    var wrappedInput = input.wrapped;
    !pools[0].involvesToken(wrappedInput) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    !pools[pools.length - 1].involvesToken(output.wrapped) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    /**
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(pools.entries()), _step; !(_step = _iterator()).done;) {
      ...
      !(currentInputToken.equals(pool.token0) || currentInputToken.equals(pool.token1)) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  ...
  _createClass(Route, [{
    ...
    get: function get() {
      ...
      return this._midPrice = new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Price */ .tA(this.input, this.output, price.denominator, price.numerator);
    }
  }]);
...
function tradeComparator(a, b) {
  ...
  !a.inputAmount.currency.equals(b.inputAmount.currency) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  !a.outputAmount.currency.equals(b.outputAmount.currency) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  ...
  function Trade(_ref) {
    ...
    }) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    ...
    !(numPools == poolAddressSet.size) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    this.swaps = routes;
    ...
    var _exactIn = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(route, amountIn) {
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", Trade.fromRoute(route, amountIn, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_INPUT));
    ...
    var _exactOut = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(route, amountOut) {
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", Trade.fromRoute(route, amountOut, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_OUTPUT));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              if (!(tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_INPUT)) {
                _context3.next = 19;
                break;
              }

              !amount.currency.equals(route.input) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
            ...
            case 15:
              inputAmount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromFractionalAmount(route.input, amount.numerator, amount.denominator);
              outputAmount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromFractionalAmount(route.output, amounts[amounts.length - 1].numerator, amounts[amounts.length - 1].denominator);
              _context3.next = 34;
              break;

            case 19:
              !amount.currency.equals(route.output) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
            ...
            case 32:
              inputAmount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromFractionalAmount(route.input, amounts[0].numerator, amounts[0].denominator);
              outputAmount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromFractionalAmount(route.output, amount.numerator, amount.denominator);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              !amount.currency.equals(route.input) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
              inputAmount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromFractionalAmount(route.input, amount.numerator, amount.denominator);
              amounts[0] = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromFractionalAmount(route.input.wrapped, amount.numerator, amount.denominator);
              i = 0;
            ...
            case 25:
              !amount.currency.equals(route.output) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
              outputAmount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromFractionalAmount(route.output, amount.numerator, amount.denominator);
              amounts[amounts.length - 1] = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromFractionalAmount(route.output.wrapped, amount.numerator, amount.denominator);
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance, amountOut) {
    ...
    !!slippageTolerance.lessThan(ZERO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;

    if (this.tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_OUTPUT) {
      return amountOut;
    } else {
      var slippageAdjustedAmountOut = new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Fraction */ .iA(ONE).add(slippageTolerance).invert().multiply(amountOut.quotient).quotient;
      return _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(amountOut.currency, slippageAdjustedAmountOut);
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance, amountIn) {
    ...
    if (this.tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_INPUT) {
      return amountIn;
    } else {
      var slippageAdjustedAmountIn = new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Fraction */ .iA(ONE).add(slippageTolerance).multiply(amountIn.quotient).quotient;
      return _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(amountIn.currency, slippageAdjustedAmountIn);
    }
  }
  /**
  ...
  _proto.worstExecutionPrice = function worstExecutionPrice(slippageTolerance) {
    return new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Price */ .tA(this.inputAmount.currency, this.outputAmount.currency, this.maximumAmountIn(slippageTolerance).quotient, this.minimumAmountOut(slippageTolerance).quotient);
  }
  /**
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              !(pools.length > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
              !(maxHops > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
              !(currencyAmountIn === nextAmountIn || currentPools.length > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
            ...
            case 28:
              ...
              _context5.t1 = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .sortedInsert */ .cW;
              _context5.t2 = bestTrades;
              _context5.next = 33;
              return Trade.fromRoute(new Route([].concat(currentPools, [pool]), currencyAmountIn.currency, currencyOut), currencyAmountIn, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_INPUT);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              !(pools.length > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
              !(maxHops > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
              !(currencyAmountOut === nextAmountOut || currentPools.length > 0) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
            ...
            case 28:
              ...
              _context6.t1 = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .sortedInsert */ .cW;
              _context6.t2 = bestTrades;
              _context6.next = 33;
              return Trade.fromRoute(new Route([pool].concat(currentPools), currencyIn, currencyAmountOut.currency), currencyAmountOut, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_OUTPUT);
  ...
  _createClass(Trade, [{
    key: "route",
    get: function get() {
      !(this.swaps.length == 1) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    ...
    get: function get() {
      ...
      }, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(inputCurrency, 0));
    ...
    get: function get() {
      ...
      var totalOutputFromRoutes = this.swaps.map(function (_ref8) {
        ...
        return total.add(cur);
      }, _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(outputCurrency, 0));
    ...
    get: function get() {
      ...
      return (_this$_executionPrice = this._executionPrice) != null ? _this$_executionPrice : this._executionPrice = new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Price */ .tA(this.inputAmount.currency, this.outputAmount.currency, this.inputAmount.quotient, this.outputAmount.quotient);
    }
    /**
    ...
    get: function get() {
      ...
      var spotOutputAmount = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(this.outputAmount.currency, 0);
      ...
      this._priceImpact = new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .Percent */ .gG(priceImpact.numerator, priceImpact.denominator);
      return this._priceImpact;
    }
  }]);
...
Multicall.INTERFACE = /*#__PURE__*/new _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__/* .Interface */ .vU(_uniswap_v3_periphery_artifacts_contracts_interfaces_IMulticall_sol_IMulticall_json__WEBPACK_IMPORTED_MODULE_2__/* .abi */ .Mt);
...
SelfPermit.INTERFACE = /*#__PURE__*/new _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__/* .Interface */ .vU(_uniswap_v3_periphery_artifacts_contracts_interfaces_ISelfPermit_sol_ISelfPermit_json__WEBPACK_IMPORTED_MODULE_4__/* .abi */ .Mt);
...
var Payments = /*#__PURE__*/function () {
  ...
  Payments.encodeUnwrapWETH9 = function encodeUnwrapWETH9(amountMinimum, recipient, feeOptions) {
    recipient = (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(recipient);

    if (!!feeOptions) {
      var feeBips = this.encodeFeeBips(feeOptions.fee);
      var feeRecipient = (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(feeOptions.recipient);
...
Payments.INTERFACE = /*#__PURE__*/new _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__/* .Interface */ .vU(_uniswap_v3_periphery_artifacts_contracts_interfaces_IPeripheryPaymentsWithFee_sol_IPeripheryPaymentsWithFee_json__WEBPACK_IMPORTED_MODULE_5__/* .abi */ .Mt);
...
var NonfungiblePositionManager = /*#__PURE__*/function () {
  ...
  NonfungiblePositionManager.addCallParameters = function addCallParameters(position, options) {
    !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(position.liquidity, ZERO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    ...
    if (isMint(options)) {
      var recipient = (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(options.recipient);
    ...
    if (options.useNative) {
      ...
      !(position.pool.token0.equals(wrapped) || position.pool.token1.equals(wrapped)) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
  ...
  NonfungiblePositionManager.encodeCollect = function encodeCollect(options) {
    ...
    var recipient = (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(options.recipient); // collect
  ...
  NonfungiblePositionManager.removeCallParameters = function removeCallParameters(position, options) {
    ...
    !jsbi__WEBPACK_IMPORTED_MODULE_1___default().greaterThan(partialPosition.liquidity, ZERO) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0; // slippage-adjusted underlying amounts
    ...
    if (options.permit) {
      calldatas.push(NonfungiblePositionManager.INTERFACE.encodeFunctionData('permit', [(0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(options.permit.spender), tokenId, toHex(options.permit.deadline), options.permit.v, options.permit.r, options.permit.s]));
    } // remove liquidity
    ...
    calldatas.push.apply(calldatas, NonfungiblePositionManager.encodeCollect(_extends({
      ...
      expectedCurrencyOwed0: expectedCurrencyOwed0.add(_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(expectedCurrencyOwed0.currency, amount0Min)),
      expectedCurrencyOwed1: expectedCurrencyOwed1.add(_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(expectedCurrencyOwed1.currency, amount1Min))
    }, rest)));
    ...
    if (options.liquidityPercentage.equalTo(ONE)) {
      ...
      !(options.burnToken !== true) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    }
  ...
  NonfungiblePositionManager.safeTransferFromParameters = function safeTransferFromParameters(options) {
    var recipient = (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(options.recipient);
    var sender = (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(options.sender);
    var calldata;
...
NonfungiblePositionManager.INTERFACE = /*#__PURE__*/new _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__/* .Interface */ .vU(_uniswap_v3_periphery_artifacts_contracts_NonfungiblePositionManager_sol_NonfungiblePositionManager_json__WEBPACK_IMPORTED_MODULE_3__/* .abi */ .Mt);
...
var SwapQuoter = /*#__PURE__*/function () {
  ...
  SwapQuoter.quoteCallParameters = function quoteCallParameters(route, amount, tradeType, options) {
    ...
    if (singleHop) {
      ...
      var v2QuoteParams = _extends({}, baseQuoteParams, tradeType == _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_INPUT ? {
      ...
      var tradeTypeFunctionName = tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_INPUT ? 'quoteExactInputSingle' : 'quoteExactOutputSingle';
      calldata = swapInterface.encodeFunctionData(tradeTypeFunctionName, options.useQuoterV2 ? [v2QuoteParams] : v1QuoteParams);
    } else {
      var _options2;

      !(((_options2 = options) == null ? void 0 : _options2.sqrtPriceLimitX96) === undefined) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
      var path = encodeRouteToPath(route, tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_OUTPUT);

      var _tradeTypeFunctionName = tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_INPUT ? 'quoteExactInput' : 'quoteExactOutput';
...
SwapQuoter.V1INTERFACE = /*#__PURE__*/new _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__/* .Interface */ .vU(_uniswap_v3_periphery_artifacts_contracts_lens_Quoter_sol_Quoter_json__WEBPACK_IMPORTED_MODULE_6__/* .abi */ .Mt);
SwapQuoter.V2INTERFACE = /*#__PURE__*/new _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__/* .Interface */ .vU(_uniswap_swap_router_contracts_artifacts_contracts_lens_QuoterV2_sol_QuoterV2_json__WEBPACK_IMPORTED_MODULE_7__/* .abi */ .Mt);
...
var Staker = /*#__PURE__*/function () {
  ...
  Staker.withdrawToken = function withdrawToken(incentiveKeys, withdrawOptions) {
    ...
    var owner = (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(withdrawOptions.owner);
  ...
  Staker._encodeIncentiveKey = function _encodeIncentiveKey(incentiveKey) {
    ...
    var refundee = (0,_uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .validateAndParseAddress */ .qn)(incentiveKey.refundee);
    return {
...
Staker.INTERFACE = /*#__PURE__*/new _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__/* .Interface */ .vU(_uniswap_v3_staker_artifacts_contracts_UniswapV3Staker_sol_UniswapV3Staker_json__WEBPACK_IMPORTED_MODULE_8__/* .abi */ .Mt);
...
var SwapRouter = /*#__PURE__*/function () {
  ...
  SwapRouter.swapCallParameters = function swapCallParameters(trades, options) {
    ...
    var calldatas = [];
    var ZERO_IN = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(trades[0].inputAmount.currency, 0);
    var ZERO_OUT = _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .CurrencyAmount */ .ih.fromRawAmount(trades[0].outputAmount.currency, 0);
    var totalAmountOut = trades.reduce(function (sum, trade) {
      return sum.add(trade.minimumAmountOut(options.slippageTolerance));
    }, ZERO_OUT); // flag for whether a refund needs to happen

    var mustRefund = sampleTrade.inputAmount.currency.isNative && sampleTrade.tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_OUTPUT;
    ...
    if (options.inputTokenPermit) {
      !sampleTrade.inputAmount.currency.isToken ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(trades), _step; !(_step = _iterator()).done;) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(trade.swaps), _step2; !(_step2 = _iterator2()).done;) {
        ...
        if (singleHop) {
          if (trade.tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_INPUT) {
          ...
          !(options.sqrtPriceLimitX96 === undefined) ?  false ? 0 : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(false) : void 0;
          var path = encodeRouteToPath(route, trade.tradeType === _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_0__/* .TradeType */ .YL.EXACT_OUTPUT);
...
SwapRouter.INTERFACE = /*#__PURE__*/new _ethersproject_abi__WEBPACK_IMPORTED_MODULE_14__/* .Interface */ .vU(_uniswap_v3_periphery_artifacts_contracts_SwapRouter_sol_SwapRouter_json__WEBPACK_IMPORTED_MODULE_9__/* .abi */ .Mt);
...
//# sourceMappingURL=chunk.npm-ns.uniswap.v3-sdk.js.map